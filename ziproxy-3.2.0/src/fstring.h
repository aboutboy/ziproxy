...
static unsigned const char	lowercase_table[] = { \
...
// comment this in order to use standard string.h routines
#define USE_CUSTOM_STRING_ROUTINES

#ifdef USE_CUSTOM_STRING_ROUTINES
#define WHICH_STRNCASECMP custom_strncasecmp
#define WHICH_STRNCMP custom_strncmp
#define WHICH_STRLEN custom_strlen
#else
#define WHICH_STRNCASECMP strncasecmp
#define WHICH_STRNCMP strncmp
